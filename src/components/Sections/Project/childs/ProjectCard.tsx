...
type ProjectCardProps = Pick<Project, "kind" | "role" | "period" | "team">;
...
const ROWS: {
  key: keyof ProjectCardProps;
  label: string;
  icon: string;
  animation: StatAnimation;
  iconSize?: string;
}[] = [
  { key: "kind", label: "Tipo", icon: "/img/icons/monitor.png", animation: "flip" },
  { key: "role", label: "Rol", icon: "/img/icons/badge.png", animation: "flip" },
  { key: "period", label: "Periodo", icon: "/img/icons/reloj.png", animation: "turn" },
  {
    key: "team",
    label: "Equipo",
...
export const ProjectCard = (props: ProjectCardProps) => (
  <div className="mx-auto w-full max-w-105 bg-[url('/img/light/project-frame.png')] bg-[length:100%_100%] bg-center bg-no-repeat px-[9%] pt-[8%] pb-[15%] dark:bg-[url('/img/dark/project-frame.png')]">
    ...
    <dl className="mt-7 flex flex-col gap-5">
      {ROWS.map(({ key, label, icon, animation, iconSize }, i) => (
